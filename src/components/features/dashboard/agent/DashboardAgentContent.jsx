...
import { AlertCircle, Clock, MapPin, Target, CheckCircle, Users, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function AgentDashboard() {
    ...
    const KPIBox = ({ icon: Icon, label, value, unit = '', color = 'text-blue-500' }) => (
        <div className="bg-white p-4 rounded-lg shadow-sm flex items-center space-x-4">
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-8">
                                ...
                                <KPIBox
                                    icon={Clock}
                                    label="Durée moyenne"
                                    value={kpis?.avgTaskDuration || '0h 00m'}
                                    color="text-orange-500"
                                />
                                <KPIBox
                                    icon={MapPin}
                                    label="Distance moyenne"
                                    value={kpis?.avgDistance || '0 km'}
                                    color="text-orange-500"
                                />
                                <KPIBox
                                    icon={Users}
                                    label="Ponctualité"
                                    value={kpis?.agentPunctuality || '0%'}
                                    color="text-orange-500"
                                />
                            </div>
                                    ...
                                    <div className="px-4 sm:px-6 py-4 border-t bg-gray-50 rounded-b-lg">
                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                                            <div className="text-sm text-gray-500 text-center sm:text-left">
                                                ...
                                                <span className="block sm:inline"> Affichage de <span className="font-medium">{tasks.length}</span> sur <span className="font-medium">{pagination.total}</span> tâche(s)</span>
                                            </div>
